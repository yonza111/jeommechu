...
urlpatterns = [
    ...
    path('restaurants_nearby/', restaurant_nearby_view.as_view(), name='restaurant_template'),  # HTML 템플릿 렌더링 URL
    path('cafes_nearby/', cafe_nearby_view.as_view(), name='cafe_nearby'),  # 템플릿 렌더링 URL
